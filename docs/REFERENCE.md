# s3disk technical reference

This document contains the protocol, security, and operational details that
were intentionally moved out of the quick-start README. Start with the
[English README](../README.md) or [中文 README](../README.zh-CN.md).
...
The optional [supported-production certification](COMMERCIAL_RELEASE.md)
...
is bounded to 128 mounts and 1 MiB. See [Mount sets](MOUNT_SET.md).
...
[S3-only expiring sharing](S3_ONLY_SHARING.md) for the complete protocol,
...
See [S3 backend commissioning](S3_COMPATIBILITY.md) for verdict semantics,
...
[S3 backend commissioning](S3_COMPATIBILITY.md) for the exact current
